...
let puntaje = parseFloat(prompt("Ingrese su puntaje de evaluación: "));
dinero = 2400*puntaje;

if (puntaje == 0.0) {
    alert(`Su nivel de rendimiento es Inaceptable y recibirá  ${dinero} euros`);
} else if (puntaje == 0.4) {
    alert(`Su nivel de rendimiento es Aceptable y recibirá  ${dinero} euros`);
} else if (puntaje => 0.6) {
    alert(`Su nivel de rendimiento es Muy buena y recibirá  ${dinero} euros`);
} 
